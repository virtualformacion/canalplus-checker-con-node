  ...
  while (reintentar) {
    ...
    try {
      ...
      const loginResult = await Promise.race([
        (async () => {
          const error = await page.waitForSelector('xpath=//*[@id="error-message"]', { timeout: 8000 }).catch(() => null);
        ...
        (async () => {
          const success = await page.waitForSelector('xpath=//*[@id="app"]/div/div/main/div/div[2]/nav/ul/li[2]/a/div[1]/div', { timeout: 20000 }).catch(() => null);
